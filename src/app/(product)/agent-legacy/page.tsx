...
import { AgentInput } from '@/components/agent-legacy/AgentInput';
import { TaskCanvas } from '@/components/agent-legacy/TaskCanvas';
...
function AgentPageInner() {
  ...
  async function handleSelectConversation(convId: string) {
    ...
    setCurrentConversationId(convId);
    currentConvRef.current = convId;
    window.history.pushState(null, '', `/agent-legacy?conversationId=${convId}`);
    setSidebarOpen(false);
  }
